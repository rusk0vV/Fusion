...
def login(request):
    ...
    base_role = str(user.extrainfo.user_type)
    designation = [base_role] if base_role else []

    for i in design:
        role_name = str(i.designation)
        if role_name and role_name not in designation:
            print('-------')
            print(i.designation)
            print(user.extrainfo.user_type)
            print('')
            designation.append(role_name)
